<x-app-layout>
    ...
    <div class="container mx-auto flex gap-0 lg:gap-20">
        <div class="isian-kiri lg:pt-[145px] pt-0">
            <p class="text-sm lg:text-sm text-[#74A512]">Sall Top 20% Off</p>
            <div class="flex text-4xl lg:text-7xl gap-2 font-bold">
            ...
            <div class="flex gap-5 pt-[40px] max-sm:justify-center">
                ...
                <button class="flex items-center text-[#74A512] text-sm">Explore Our Blog <img class="pl-2" src="./panah.svg" alt=""></button>
            </div>
        </div>
       <div class="slider lg:block hidden w-[200px] h-[100px] lg:w-[500px] lg:h-[400px] overflow-hidden">
            <div class="slides w-[200%] h-[200px] lg:w-[500%] lg:h-[500px] flex ">
                ...
                <div class="slidefirst w-[100px] h-[150px] lg:w-[600px] lg:h-[450px]   ">
                    <img src="{{ asset('file/makanan1.png') }}" alt="">
                </div>
                <div class="slide w-[20%] duration-[2s]">
                    <img class="w-[150px] h-[200px] lg:w-[350px] lg:h-[400px]" src="{{ asset('file/organicfood.svg') }}" alt="">
                </div>
                <div class="slide  w-[20%] duration-[2s]">
                    <img class=" w-[400px] h-[400px]" src="{{ asset('file/makan3.png') }}" alt="">
                </div>

                <div class="autonav absolute w-[100px] flex justify-center gap-5 right-[18rem] pt-5 duration-[2s] top-[30rem] ">
                    <div class="auto-btn1  border-2 p-[5px] border-orange-400 rounded-full cursor-pointer  hover:bg-[#74A512]  "></div>
                    <div class="auto-btn2  border-2 p-[5px] border-orange-400 rounded-full cursor-pointer  hover:bg-[#74A512]"></div>
                    <div class="auto-btn3  border-2 p-[5px] border-orange-400 rounded-full cursor-pointer  hover:bg-[#74A512]"></div>
                </div>
            </div>
            <div class="navmanual absolute w-[100px] flex justify-center gap-5 right-[18rem] pt-5 duration-[2s] top-[30rem]">
                <label for="radio1" class="manual-btn border-2 p-[5px] border-orange-400 rounded-full cursor-pointer  hover:bg-[#74A512]"></label>
                <label for="radio2" class="manual-btn border-2 p-[5px] border-orange-400 rounded-full cursor-pointer  hover:bg-[#74A512]"></label>
                <label for="radio3" class="manual-btn border-2 p-[5px] border-orange-400 rounded-full cursor-pointer  hover:bg-[#74A512]"></label>
            </div>
       </div>
    </div>
