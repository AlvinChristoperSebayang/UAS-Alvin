...
<body class="bg-cover bg-center bg-fixed bg-no-repeat w-full z-10" style="background-image: url(file/bg_regis.jpg)">
    <header class="sticky top-0 z-20">
        ...
        <form action="{{url('/pesanAdmin')}}" method="POST"class="pt-10 absolute left-1/2 -translate-x-1/2 w-[40%]  ">
            @csrf
            <h1 class="font-bold text-4xl w-full text-center pb-10">
                ...
                <div class="flex w-full justify-between">
                    <div>
                        ...
                        <x-text-input id="ownerName" class="block mt-1 w-full" type="text" name="ownerName" :value="old('ownerName')"  autofocus />
                    </div>
                    <div>
                        <x-input-label for="storeName" :value="__('Store Name')" />
                        <x-text-input id="storeName" class="block mt-1 w-full" type="text" name="storeName" :value="old('storeName')"  autofocus />
                    </div>
                </div>
