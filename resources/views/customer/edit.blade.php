...
<div>
    ...
    <form action="{{url('updateCustomer/'.$customer->id)}}" method="POST"class="pt-10 absolute left-1/2 -translate-x-1/2 w-[40%]  ">
        @csrf
        @method('PUT')
        <h1 class="font-bold text-4xl w-full text-center pb-10">
            ...
            <div class="flex w-full justify-between">
                <div>
                    <x-input-label for="ownerName" :value="__('Owner Name')" />
                    <x-text-input id="ownerName" class="block mt-1 w-full" type="text" name="ownerName" :value="$customer->ownerName" autofocus />
                </div>
                <div>
                    <x-input-label for="storeName" :value="__('Store Name')" />
                    <x-text-input id="storeName" class="block mt-1 w-full" type="text" name="storeName"  :value="$customer->storeName"  autofocus />
                </div>
            </div>
    
    
            <div>
                <x-input-label for="typefood" :value="__('Type Food')" />
                <div class="flex flex-col w-full">
                    <select id="typefood" name="typefood">
            ...
            <div>
                <x-input-label for="address" :value="__('Address Store')" />
                <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" :value="$customer->address" autofocus />
            </div>
