...
<body class="bg-cover bg-center bg-fixed bg-no-repeat w-full z-10" style="background-image: url(file/bg_regis.jpg)">
    ...
    <x-success-status class="font-bold mb-4 z-50" :status="session('message')" />
        <table class="border-solid border-2 border-black w-full">
            <thead>
                <tr>
                
                    <th class="border-solid border-2 border-black">id</th>
                    <th class="border-solid border-2 border-black">Owner Name</th>
                    <th class="border-solid border-2 border-black">Store Name</th>
                    <th class="border-solid border-2 border-black">Type Food</th>
                    <th class="border-solid border-2 border-black">Address</th>
            ...
            <tbody class="w-full">
                ...
                <tr>
                    <td class="border-solid border-2 border-black">{{$customer->id}}</td>
                    <td class="border-solid border-2 border-black">{{$customer->ownerName}}</td>
                    <td class="border-solid border-2 border-black">{{$customer->storeName}}</td>
                    <td class="border-solid border-2 border-black">{{$customer->typefood}}</td>
                    <td class="border-solid border-2 border-black">{{$customer->address}}</td>
                    <td class="text-center">
                        <a href="{{url('/edit-customer/'.$customer->id)}}" class="bg-green-500 hover:bg-green-400 text-white px-6 rounded-lg">Edit</a>
                    </td>
                    <td class="text-center">
