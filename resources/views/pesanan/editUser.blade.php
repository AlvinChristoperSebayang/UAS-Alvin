...
<header class="sticky top-0 z-20">
    <nav class="container mx-auto">
        ...
        <form action="{{url('daftar-pesanan/'.$pesanan->id)}}" method="POST"class="pt-10 absolute left-1/2 -translate-x-1/2 ">
            @csrf
            @method('PUT')
            ...
            <h1 class="font-bold text-4xl w-full text-center pb-10">
                ...
                <div class="w-full justify-between">
                    <div>
                        ...
                        <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" :value="$pesanan->nama"  autofocus />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <x-text-input id="alamat" class="block mt-1 w-full" type="text" name="alamat" :value="$pesanan->alamat"  autofocus />
                    </div>
                </div>
                ...
                <div class="flex justify-center pt-10">
                    ...
                    <x-primary-button class="ml-3"><a href="/daftar-pesanan"></a>
                        {{ __('Update Pesanan') }}
                    </x-primary-button>
                </div>
            </form>
